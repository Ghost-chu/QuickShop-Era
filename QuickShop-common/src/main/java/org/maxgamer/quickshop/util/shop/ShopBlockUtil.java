...
package org.maxgamer.quickshop.util.shop;
...
public class ShopBlockUtil {
    private final List<CrossPlatformMaterial> shoppables;
     ...
     * @return Can or not
     */
    public boolean isShoppables(@NotNull CrossPlatformMaterial material) {
